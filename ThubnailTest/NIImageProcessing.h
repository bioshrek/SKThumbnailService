...
typedef enum {
    NIImageViewScaleToFitLeavesExcessAndScaleToFillCropsExcess = 0x00,
    NIImageViewScaleToFitCropsExcess    = 0x01,
    NIImageViewScaleToFillLeavesExcess  = 0x02,
} NIImageViewScaleOptions;
...
/**
 * Calculate the scaled rect for thumbnail image.
 */
