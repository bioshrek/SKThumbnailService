...
+ (CGRect)sourceRectWithImageSize:(CGSize)imageSize
  ...
  if (UIViewContentModeScaleToFill == contentMode) {
    ...
    // Not implemented
    NSLog(@"The following content mode has not been implemented: %zd", contentMode);
    return CGRectMake(0, 0, imageSize.width, imageSize.height);
  }
}
...
+ (UIImage *)imageFromSource:(UIImage *)src
             withContentMode:(UIViewContentMode)contentMode
                 ...
                 displaySize:(CGSize)displaySize
                scaleOptions:(NIImageViewScaleOptions)scaleOptions
  ...
  if (0 < displaySize.width
    ...
    if ((NIImageViewScaleToFillLeavesExcess
         == (NIImageViewScaleToFillLeavesExcess & scaleOptions))
        && UIViewContentModeScaleAspectFill == contentMode) {
    ...
    } else if ((NIImageViewScaleToFitCropsExcess
                == (NIImageViewScaleToFitCropsExcess & scaleOptions))
...
+ (CGRect)scaledRectForImageSize:(CGSize)imageSize
                displaySize:(CGSize)displaySize
                contentMode:(UIViewContentMode)contentMode
               scaleOptions:(NIImageViewScaleOptions)scaleOptions
{
